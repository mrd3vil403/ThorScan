...
def get_arg():
    ...
    parser.add_argument("-t", "--threads", dest="threads",metavar="",help="Specify Threads(Default 600 (MAX - 849))")
    parser.add_argument("-ip", "--host", dest="host",metavar="",help="Specify Host IP address")
    parser.add_argument("-s", "--start_port", dest="start",metavar="",help="Specify Starting Port Number(Default 1)")
    parser.add_argument("-e", "--end_port", dest="end",metavar="",help="Specify Ending Port Number(Default 65535)")
...
def portmapper():
	cprint(figlet_format('THORSCAN', font='standard'),'yellow', attrs=['bold'])

	print(style.BLUE+style.BOLD+style.UNDERLINE+"\r\t\t\t\tBY - Mudassir Ansari\n"+style.RESET+style.BOLD+style.WHITE)
...
for single_port in open_ports:
	if single_port == 20:
		...
		print(" P.NO",str(count)+"\r\t\t"+str(single_port)+"\r\t\t\t\tsmb/samba or netbios-ssn")
		...
		print(" P.NO",str(count)+"\r\t\t"+str(single_port)+"\r\t\t\t\tsmb/samba or microsoft-ds")
		...
		print(" P.NO",str(count)+"\r\t\t"+str(single_port)+"\r\t\t\t\trmiregistry")
	elif single_port == 1524:
		print(" P.NO",str(count)+"\r\t\t"+str(single_port)+"\r\t\t\t\tingreslock")
		...
		print(" P.NO",str(count)+"\r\t\t"+str(single_port)+"\r\t\t\t\tccproxy-ftp")
	elif single_port == 3306:
		print(" P.NO",str(count)+"\r\t\t"+str(single_port)+"\r\t\t\t\tmysql")
	elif single_port == 3632:
		print(" P.NO",str(count)+"\r\t\t"+str(single_port)+"\r\t\t\t\tdistccd")
	elif single_port == 5432:
		print(" P.NO",str(count)+"\r\t\t"+str(single_port)+"\r\t\t\t\tpostgresql")
		...
		print(" P.NO",str(count)+"\r\t\t"+str(single_port)+"\r\t\t\t\tmsgsrvr")
	elif single_port == 18182:
		print(" P.NO",str(count)+"\r\t\t"+str(single_port)+"\r\t\t\t\topsec-ufp")
	else:
		print(" P.NO",str(count)+"\r\t\t"+str(single_port)+"\r\t\t\t\tunassigned")
	count +=1
